      ...
      <div className="flex-1 overflow-y-auto p-3 sm:p-4">
        {isLoading ? (
          ...
          <div className="p-8 text-center rounded-2xl bg-zinc-50 dark:bg-zinc-850 border border-zinc-200/80 dark:border-zinc-800">
            ...
            <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">No recommendations available</p>
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
              Click refresh to discover more related videos for this topic.
            </p>
            <button
              type="button"
              onClick={() => fetchRecommendations(true)}
              className="mt-3 px-3.5 py-1.5 rounded-xl text-xs font-semibold bg-red-600 hover:bg-red-700 text-white transition-colors cursor-pointer"
            >
              Discover Videos
            </button>
          </div>
