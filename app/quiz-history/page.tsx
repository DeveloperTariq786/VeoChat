  ...
  return (
    <div id="quiz-history-page" className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 flex flex-col font-sans antialiased">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6">
        ...
        {!authLoading && !user && (
          <div className="p-6 rounded-3xl bg-white dark:bg-zinc-900 border border-red-500/20 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
            <div className="space-y-1">
              <div className="flex items-center justify-center sm:justify-start gap-2 text-red-600 dark:text-red-400">
                <Sparkles className="w-4 h-4" />
                <span className="font-bold text-sm">Sign in to save and analyze your quiz results</span>
              </div>
              <p className="text-xs text-zinc-500 dark:text-zinc-400 max-w-xl">
                VeoChat automatically tracks your scores across video quizzes and provides detailed diagnostic reports to reinforce knowledge retention.
              </p>
            </div>
            <button
              type="button"
              onClick={signInWithGoogle}
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold bg-zinc-900 hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-200 text-white dark:text-zinc-900 transition-all cursor-pointer shadow-xs whitespace-nowrap"
            >
