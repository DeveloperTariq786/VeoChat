...
export default function HistoryPage() {
  return (
    <AuthGuard
      title="History & Analytics Protected"
      description="You must be signed in with your Google account to access your saved search and quiz history."
    >
